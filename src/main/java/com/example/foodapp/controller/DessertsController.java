...
public class DessertsController {
    ...
    private String chosenDietTypeValue;
    ...
    @FXML
    private ComboBox<String> healthDessertsComboBox;

    @FXML
    private ComboBox<String> cuisineTypeDessertsComboBox;

    @FXML
    private ComboBox<String> dietDessertsComboBox;
    @FXML
    ...
    public String getQuery(){
        ...
        if(chosenDietTypeValue != null){
            query += "&diet=";
            query += chosenDietTypeValue;
        }
